      ...
      setState(
        () {
          _convertedValue = _isKg
              ...
              : WeightConverter.lbsToKg(
                  input,
                );
        },
      );
      // Auto-save current weight
      widget.storage.saveCurrentWeight(
        input,
      );
